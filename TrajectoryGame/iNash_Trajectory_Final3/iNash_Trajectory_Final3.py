...
def extend_graph(vertex_rand, robot_root, obstacles, goal_set, pywindow, color_, k, x):  # add vertex and edges to sets for robot i
    #print 'extend called.'
    #print 'vert_rand:', vertex_rand.x, vertex_rand.y, vertex_rand.x_vel, vertex_rand.y_vel
    ...
    #print 'vert_nearest:', vertex_nearest2.x, vertex_nearest2.y, vertex_nearest2.x_vel, vertex_nearest2.y_vel
    ...
    #print 'vert_new:', vertex_new2.x, vertex_new2.y, vertex_new2.x_vel, vertex_new2.y_vel
    #print 'distance for new point from tree:', norm(vertex_new2, vertex_nearest2)
...
def main():
    pywindow, obstacles, axis = init_pywindow('i-Nash Trajectory Final 3')    # set up pygame window, dimensions and obstacles
