...
from path_funcs import path_generation2, find_optimal_path, collision_free_path, display_path, print_paths, draw_traj
...
def extend_graph(vertex_rand, robot_root, obstacles, goal_set, pywindow, color_, k, x, goal):   # add vertex and edges to sets for robot i
    ...
    if k % 2 == 0 and k < 500:     # nearest is from tree1 from root
        tree_num = 1
        first = robot_root
