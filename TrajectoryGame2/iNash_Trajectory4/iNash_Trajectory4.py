...
from math import *
from pywindow_funcs import init_pywindow, user_prompt, iterate_or_stop, draw_obstacles
...
def main():
    pywindow, buttons, active_bots, paths, costs, robo_colors, k_end, robot_times, total_time, obstacles = form_trees_and_paths()
    ...
    run_simulator(pywindow, active_bots, paths, costs, robo_colors, buttons, obstacles)
