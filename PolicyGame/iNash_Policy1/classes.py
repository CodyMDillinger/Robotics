...
class Dimensions:               # pywindow, obstacles, radii, theorem 38 calculations
    ...
    obs_volume = obs_area * (len(obs_list) - 1) * 4.0 * Settings.robo_vel_max    # total obstacle 4-D lebesgue obstacle space
    ...
    gamma_min = 2.0 * ((1.0 + 1.0 / dimen) ** (1.0 / dimen)) * ((free_space / unit_ball) ** (1.0 / dimen))    # from theorems 34 to 39
