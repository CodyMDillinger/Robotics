...
Below is a display of the 2-D simulation of the policy algorithm. Notice fast-slow-fast-slow etc behavior, due to bang-bang control.
<img src="https://github.com/CodyMDillinger/Robotics/blob/master/gifs/iNash_Policy_Sim.gif" width="500" height="850"/>
