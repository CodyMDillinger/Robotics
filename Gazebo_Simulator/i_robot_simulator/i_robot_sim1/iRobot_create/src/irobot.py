...
# Load the RobotController class, which handles interactions with the robots
...
def move(x1,y1,x2,y2,x3,y3,x4,y4):
    ...
    while abs(angle_difference1)>0.05 or abs(angle_difference2)>0.05 or abs(angle_difference3)>0.05 or abs(angle_difference4)>0.05:
      robot1_x,robot1_y,yaw1=measurement(1)
      robot2_x,robot2_y,yaw2=measurement(2)
      robot3_x,robot3_y,yaw3=measurement(3)
      robot4_x,robot4_y,yaw4=measurement(4)
